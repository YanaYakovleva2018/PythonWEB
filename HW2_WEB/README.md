...
# abvad(“address_book_vad персональний консольний помічник”)
...
* скачайте папку з проектом з репозиторію за посиланням https://github.com/VadimTrubay/abvad.git
* щоб встановити цей пакет з початкового коду, виконайте в консолі pip install  або pip install -e  у папці, де лежить setup.py;
* після установки в системі з'являється пакет abvad;
* коли пакет встановлений в системі, скрипт можна викликати у будь-якому місці з консолі командою abvad;
